...
class Order(models.Model):
    ...
    departure_date = models.CharField(null=True, blank=True, max_length=50)
    arrival_date = models.CharField(null=True, blank=True, max_length=50)
    departure_time = models.CharField(null=True, blank=True, max_length=50)
    arrival_time = models.CharField(null=True, blank=True, max_length=50)
